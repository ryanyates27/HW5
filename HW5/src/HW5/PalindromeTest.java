...
public class PalindromeTest {
    ...
    //for the first half of the string you push each char onto a stack
    //then for the second half you check if the popped char
    //from the stack is equal to the second half of the char array
